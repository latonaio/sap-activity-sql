CREATE TABLE `sap_email_recipients_data`
(
		...
		CONSTRAINT `SAPEmailCollectionEmailRecipientsData_fk` FOREIGN KEY (`ObjectID`) REFERENCES `sap_email_collection_data` (`ObjectID`)
) ENGINE = InnoDB
